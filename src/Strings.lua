...
WarbandStorage.Strings = LuckyStrings.New("WarbandStorage.Strings", {
    ...
    sets = {
        ...
        type               = "Set Type",
        typeDesc           = "Keep in Bags withdraws each item up to its Keep amount. Deposit All sends every item on the list to your Warband Bank. A reagent set can instead Withdraw All, taking every reagent of its kind from your Warband Bank beyond its Reserve.",
        typeKeep           = "Keep in Bags",
        typeWithdrawAll    = "Withdraw All",
    ...
    standard = {
        ...
        lumber       = "Lumber",
        housingDye   = "Housing Dye",
        treatise     = "Weekly Treatise",
        warbound     = "Warbound Items",
        withdrawName = "%s: Withdraw",
        depositName  = "%s: Deposit",
        ...
        reagentWithdrawDesc = "A standard set: every reagent in the %s category comes out of your Warband Bank when you open it, leaving each item's Reserve behind. Handy for a character who sells them.",
    ...
    report = {
        ...
        lineAll = "%s (%d): have %d, withdraw all",
