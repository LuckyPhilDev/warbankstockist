...
-- ## String Constants
-- ############################################################
local SETTINGS_NAME                         = "Lucky's Warband Stockist"
local STR_TITLE                             = "Lucky's Warband Stockist Settings"
...
local STR_FILTER_ITEMS_PLACEHOLDER          = "Filter items..."
...
WarbandStorage.Theme.STRINGS = {
  ...
  FILTER_ITEMS_PLACEHOLDER = STR_FILTER_ITEMS_PLACEHOLDER,
  ...
  DEFAULT_QTY_ZERO = STR_DEFAULT_QTY_ZERO,
  DEFAULT_QTY_ZERO_TOOLTIP = STR_DEFAULT_QTY_ZERO_TOOLTIP,
